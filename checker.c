...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/08 21:27:44 by savas11           #+#    #+#             */
/*   Updated: 2022/09/08 21:27:50 by savas11          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** ft_action_processing - İşlev, eylemi şu şekilde alır:
** bir dize olarak ve istenen işlevi çalıştırır.
*/
...
/*
**	ft_read_action - bekleyen bir işlev
** 	konsoldan komut yazma ve yönlendirme
** 	işleme işlevine komut.
*/
...
/*
** 	ft_stack_sorted - yığının sıralama için kontrol edilmesi.
*/
