...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/08 21:37:34 by savas11           #+#    #+#             */
/*   Updated: 2022/09/08 21:37:37 by savas11          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** ft_global_sort - sıralama algoritması
** her boyuttaki sayılar baza yazılır
** ekleme sıralama. Bu işlev
** yığını sıralama için hazırlar.
*/
...
/*
**		ft_start_sort - sıralama işlemini başlat.
*/
...
/*
** ft_steps_markup - yığının her bir öğesinin işaretlenmesi
** öğenin atması gereken adım sayısı
** zirveye ulaştı (ilk pozisyona).
*/
...
/*
** ft_minimum_insertion_steps - bulan bir işlev
** minimum adım sayısı ile hareket ettirilebilen eleman.
*/
...
/*
** ft_instruction_execution bir işlevdir
** önceden ayarlanmış parametrelere göre eylemler gerçekleştirir.
*/
